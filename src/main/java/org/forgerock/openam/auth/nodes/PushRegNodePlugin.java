 ...
 */
public class PushRegNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public PushRegNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    public void upgrade(String fromVersion) throws PluginException {
        pluginTools.upgradeAuthNode(PushRegNode.class);
